...
public static void main(String[] args) throws IOException {
		...
		Select select1= new Select(wbsele1);
		select1.selectByVisibleText(industries);
		...
		{
			System.out.println(industries+ "is created");
		}else
			System.out.println(industries+ "is not created");
